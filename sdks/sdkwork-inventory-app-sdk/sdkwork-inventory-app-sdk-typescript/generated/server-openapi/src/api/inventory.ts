...
export class InventoryStocksAdjustmentsApi {
...
export class InventoryStocksApi {
  private client: HttpClient;
  public readonly adjustments: InventoryStocksAdjustmentsApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.adjustments = new InventoryStocksAdjustmentsApi(client);
  }
